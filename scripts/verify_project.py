...
version='20260816-railway-mobile-stable-v14'
...
if 'assets/images/entrada-batata-frita.webp?v=20260816-railway-mobile-stable-v14' not in menu_text:
...
if 'assets/images/entrada-bolinho-frito-molho-branco.png?v=20260816-railway-mobile-stable-v14' not in menu_text:
    fail.append('Imagem final PNG do bolinho não está referenciada')
if 'assets/images/pizza-havaiana-card-master.png?v=20260816-railway-mobile-stable-v14' not in menu_text:
...
if 'responsaveis-pai-degua-v9-card-720.webp?v=20260816-railway-mobile-stable-v14' not in html:
    fail.append('Imagem responsiva de Rute e Cley não está referenciada')

# Mobile stable V14 checks
html_text=(ROOT/'index.html').read_text(encoding='utf-8')
app_text=(ROOT/'js/app.js').read_text(encoding='utf-8')
sw_text=(ROOT/'sw.js').read_text(encoding='utf-8')
if 'href="#salada">Saladas</a>' not in html_text: fail.append('Saladas ausente no menu')
if '-card-720.webp' not in app_text or '-display-1280.webp' not in app_text: fail.append('Variantes responsivas V14 ausentes')
if "if(url.pathname.startsWith('/assets/images/')) return;" not in sw_text: fail.append('SW ainda intercepta imagens')
if '20260816-railway-mobile-stable-v14' not in (ROOT/'server.js').read_text(encoding='utf-8'): fail.append('Servidor não está na V14')
