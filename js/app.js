(() => {
  ...
  function initServiceWorker(){if('serviceWorker' in navigator && location.protocol!=='file:')window.addEventListener('load',()=>navigator.serviceWorker.register('/sw.js?v=20260814-final-cley-rute-v5').catch(err=>console.warn('Service worker não registrado:',err)));}
